...
// import { AuthContext } from "../Context/AuthContext"; // Assuming AuthContext is set up for user state
...
//       navigate("/");
//     } else {
//       fetch("https://y-lac-five.vercel.app/toDo")
...
//     try {
//       const response = await fetch("https://y-lac-five.vercel.app/toDo", {
//         method: "POST",
...
//     try {
//       await fetch(`https://y-lac-five.vercel.app/toDo/${task._id}`, {
//         method: "PUT",
//         headers: { "Content-Type": "application/json" },
...
//     try {
//       await fetch(`https://y-lac-five.vercel.app/toDo/${taskId}`, { method: "DELETE" });
//     } catch (error) {
